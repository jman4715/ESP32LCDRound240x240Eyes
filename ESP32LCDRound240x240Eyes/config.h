...
#define TFT1_CS 14         // TFT 1 chip select pin (set to -1 to use TFT_eSPI setup)
#define TFT2_CS 15         // TFT 2 chip select pin (set to -1 to use TFT_eSPI setup)
#define TFT_1_ROT 0        // TFT 1 rotation // 0 = 0° pins bottom, 2 = 180° pins top
